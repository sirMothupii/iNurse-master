...
public class ConnectActivity extends Activity {
    ...
    private static final String BASE_URL = "https://api.humanapi.co/v1/human/medical/allergies";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try {
            ...
            ub.path("embed");
            ub.appendQueryParameter("0a3c4405a22f05106bcb11165858dd2646811924", clientId);
            ub.appendQueryParameter("iamkeenan07@gmail.com", userId);
            ub.appendQueryParameter("Access-Control-Allow-Headers ", "Content-Type, Authorization, Accept");
            ub.appendQueryParameter("Access-Control-Allow-Methods ", "OPTIONS,GET,HEAD");
            ub.appendQueryParameter("Access-Control-Allow-Origin ", "*");
            ub.appendQueryParameter("Access-Control-Max-Age", "86400");
            ub.appendQueryParameter("Connection ", "keep-alive");
            ub.appendQueryParameter("Content-Length ", "2906");
            ub.appendQueryParameter("Content-Type", "application/json; charset=utf-8");
            ub.appendQueryParameter("Date ", "Sun, 30 Sep 2018 01:41:54 GMT");
            ub.appendQueryParameter("ETag", "W/\"b5a-W6IAjdLovED9oNphAi8gd62EFu0\"");
            ub.appendQueryParameter("Server", "nginx");
            ub.appendQueryParameter("X-Powered-By", "Express");
            ub.appendQueryParameter("X-Total-Count", "5");


            if (publicToken != null) {
                ub.appendQueryParameter("demo", publicToken);
            }
            if(options != null)
            {
    ...
    private void onFinish(String url)
    {
        ...
        data.put("0a3c4405a22f05106bcb11165858dd2646811924", clientId);
        data.put("iamkeenan07@gmail.com", humanId);
        ...
        try
        {
            ...
            intent.putExtra("public_token", res.get("demo").toString());
